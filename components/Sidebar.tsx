...
export default function Sidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  const THEMES: { t: Theme; Icon: () => React.ReactElement; label: string }[] = [
  ...
  return (
    <aside style={{
      width: 240, flexShrink: 0, height: "100%", background: SURFACE,
      ...
      {/* Rodapé: tema + usuário */}
      <div style={{ borderTop: `1px solid ${LINE}`, padding: SP.md, display: "flex", flexDirection: "column", gap: SP.md }}>
